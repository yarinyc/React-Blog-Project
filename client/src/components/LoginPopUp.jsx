    ...
    <Popup
      ...
      <Form className="loginPopup" onSubmit={this.handleSubmit}>
        <Form.Group controlId="_userName">
          ...
          <Form.Control type="username" onChange={this.handleUserName} placeholder="UserName" />
        </Form.Group>

        <Form.Group controlId="exampleForm.ControlTextarea1">
          <Form.Label>Password</Form.Label>
          <Form.Control type="password" onChange={this.handlePassword} placeholder="Password"/>
        </Form.Group>
